...
const NavbarItem = ({title, classProps}) => {
    return (
        <li className={`mx-4 border-y-2 border-transparent hover:border-[#2952e3] cursor-pointer  ${classProps}`}>{title}</li>
    )
}
const Navbar = () => {
    ...
    return (
        <nav className="w-full flex md:justify-center justify-between items-center p-4">
            ...
            <div className="flex relative">
                ...
                {toggleMenu && (
                    <ul className=" z-10 fixed top-0  -right-2 p-3 w-[70vw] shadow-2xl md:hidden
